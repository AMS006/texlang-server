...
const { getDownloadProjectWorks, getUploadProjectWorks, getUserWorksForUpdate, updateUserWorks, uploadUserProjectWork, getWorkForCompanyBilling, getGenerateInvoiceWorks } = require('../../controllers/megdapAdmin/work');
...
router.post('/uploadCustomerFile',upload.single('file'),uploadUserProjectWork);
